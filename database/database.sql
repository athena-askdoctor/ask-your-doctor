...
CREATE TABLE IF NOT EXISTS `skkkzhan_athenahack2021_db`.`blogs` (
  ...
  PRIMARY KEY (`idblogs`),
  INDEX `fk_blogs_users1_idx` (`userid` ASC),
...
CREATE TABLE IF NOT EXISTS `skkkzhan_athenahack2021_db`.`blog_tag` (
  ...
  INDEX `fk_blog_tag_blogs1_idx` (`blogid` ASC),
  INDEX `fk_blog_tag_tags1_idx` (`tagid` ASC),
...
CREATE TABLE IF NOT EXISTS `skkkzhan_athenahack2021_db`.`chats` (
  ...
  PRIMARY KEY (`idchats`),
  INDEX `fk_chats_users_idx` (`from` ASC),
  INDEX `fk_chats_users1_idx` (`to` ASC),
...
CREATE TABLE IF NOT EXISTS `skkkzhan_athenahack2021_db`.`likes` (
  ...
  INDEX `fk_likes_blogs1_idx` (`blogid` ASC),
